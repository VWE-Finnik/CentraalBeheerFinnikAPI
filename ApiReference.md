...
**Get Access Token:**
```bash
curl -X POST "https://fin-fa-backend-dev-v2-weu.azurewebsites.net/api/authorize" \
...
**Get Car Report:**
```bash
curl -X GET "https://fin-fa-backend-dev-v2-weu.azurewebsites.net/api/CbCarReport?licensePlateNumber=ABC123D" \
